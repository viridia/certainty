...
/** Ensure that the value being tested is an empty array or object.
...
/** Ensure that the value being tested is a non-empty array or object.
    @return {ArraySubject} `this` for chaining.
*/
...
/** Ensure that the value being tested has a length equal to the specified length.
...
/** Ensure that the value being tested contains the given element.
