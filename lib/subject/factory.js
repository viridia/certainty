...
function SubjectFactory() {
  ...
  // Objects
  this.addType(function(t) { return typeof t === 'object'; }, ObjectSubject);
  ...
  if (typeof Promise != 'undefined') {
    ...
    this.addType(function(t) { return t instanceof Promise; }, PromiseSubject);
  }

  // Maps
  if (typeof Map != 'undefined') {
    var MapSubject = require('./mapSubject');
    this.addType(function(t) { return t instanceof Map; }, MapSubject);
  }

  // Sets
  if (typeof Set != 'undefined') {
    var SetSubject = require('./setSubject');
    this.addType(function(t) { return t instanceof Set; }, SetSubject);
  }
