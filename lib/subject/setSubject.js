...
SetSubject.prototype.isEmpty = function () {
  if (this.value.size !== 0) {
    this.failureStrategy.fail('Expected ' + this.describe() + ' to be an empty set.');
  }
  return this;
};
...
SetSubject.prototype.isNotEmpty = function () {
  if (this.value.size === 0) {
    this.failureStrategy.fail('Expected ' + this.describe() + ' to be a non-empty set.');
  }
  return this;
};
...
SetSubject.prototype.hasSize = function (size) {
  if (this.value.size !== size) {
    this.failureStrategy.fail('Expected ' + this.describe() + ' to be of size ' + size +
...
SetSubject.prototype.contains = function (value) {
  if (!this.value.has(value)) {
    this.failureStrategy.fail('Expected ' + this.describe() + ' to contain ' + format(value) + '.');
  }
  return this;
};
...
SetSubject.prototype.containsAllIn = function (elements) {
  ...
  if (missing.length > 0) {
    this.failureStrategy.fail('Expected ' + this.describe() + ' to contain all of ' +
