/** Represents the value being checked, and provides assertion methods. Can be subclassed to
    ...
    @param failureStrategy The failure strategy to use when an assertion fails.
*/
function Subject(value, failureStrategy) {
...
/** Failure method for simple comparison assertions.
    @param verb The name of the comparison verb, such has 'greater than'.
